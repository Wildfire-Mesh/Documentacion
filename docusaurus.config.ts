...
const config: Config = {
  ...
  url: 'https://wildfire-mesh.github.io',
  ...
  organizationName: 'wildfire-mesh', // Usually your GitHub org/user name.
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/wildfire-mesh/Documentacion/tree/main',
        },
        blog: {
